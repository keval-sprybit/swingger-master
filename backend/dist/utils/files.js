...
export async function storeRawFile(buffer, originalName, tradingDate) {
    const sub = `${tradingDate.getFullYear()}/${String(tradingDate.getMonth() + 1).padStart(2, "0")}/${String(tradingDate.getDate()).padStart(2, "0")}`;
